  ...
  useEffect(() => {
    ...
    const fetchDepartments = async () => {
      try {
        ...
        const defaultDeptId =
          formated.find((d) => d.label === lecturer.department.name)?.value ||
          "";
        setFormData((prev) => ({
          ...prev,
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex gap-4 text-3xl">
            <div className="font-bold">
              {lecturer.LecID} <span className="font-extrabold">-</span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
            ...
            <div className="flex flex-col">
              ...
              <select
                ...
                type="text"
              >
                <option value="Null" className="select-bg">
                  --Select--
                </option>
          ...
          <div className="flex flex-col">
            ...
            <Select
              ...
              value={courses.filter((course) =>
                formData.courses.includes(course.value)
              )}
              name="courses"
              options={courses}
              className="text-black"
          ...
          <div className="justify-end">
            ...
            <button className="action-decline ml-4" onClick={onClose}>
              Cancel
            </button>
          </div>
        </div>
