        ...
        <div className="space-y-4 p-5">
          <div className="flex justify-between items-center mb-4">
            ...
            <button className=" hover:cursor-pointer">
              <X size={22} onClick={onClose} className="w-6 h-6" />
            </button>
          </div>
          <p className="font-semibold">
            Are you sure you want to delete{" "}
            <span className="font-bold text-green-400">{student.name}</span>?
          </p>
          ...
          <div className="text-left p-4">
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>
                <span className="font-bold">Reg No:</span> {student.regNo}
              </li>
              <li>
              ...
              <li>
                <span className="font-bold">Date enrolled:</span>{" "}
                {student.admDate}
              </li>
            </ul>
          </div>
          <div className="flex justify-end gap-8">
            <button className="action-decline" onClick={onClose}>
              Cancel
            </button>
            <button className="bg-red-500 action-accept" onClick={handleDelete}>
